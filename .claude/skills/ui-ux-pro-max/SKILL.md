---
name: ui-ux-pro-max
description: "Searchable UI/UX knowledge base (Python CLI) with 67 styles, 96 color palettes, 57 font pairings, 99 UX guidelines and stack-specific rules (html-tailwind by default). Use to generate or persist a design system (colors, typography, landing structure, anti-patterns) or to look up palettes, fonts, landing patterns and UX/accessibility rules ('paleta de colores', 'tipografía', 'sistema de diseño', 'qué fuente uso', 'estructura de la landing')."
---
# ui-ux-pro-max

Comprehensive design guide for web and mobile applications. Contains 67 styles, 96 color palettes, 57 font pairings, 99 UX guidelines, and 25 chart types across 13 technology stacks. Searchable database with priority-based recommendations.

## Asadero Kikos — project notes (read first)
...
Check that Python is available (`python --version`). If it is missing on Windows: `winget install Python.Python.3.12`.
...
- **Stack**: `html-tailwind` for this project (Tailwind CDN + vanilla JS)
...
This creates (the folder name is the slugified `-p` project name, e.g. `design-system/asadero-kikos/`):
